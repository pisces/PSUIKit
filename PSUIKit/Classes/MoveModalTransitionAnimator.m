...
#import "MoveModalTransitionAnimator.h"
#import "PSUIKit.h"

@implementation MoveModalTransitionAnimator
...
- (void)animateTransitionForDismission:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] delay:0 options:animationOptions animations:^{
        ...
        fromViewController.view.y = fromViewController.view.y >= 0 ? fromViewController.view.height : -fromViewController.view.height;
